...
class DeviceWithVolume3ServiceTests(unittest.TestCase):
    ...
    async def setUp(self, mocked):
        ...
        with open(
            os.path.join(os.path.dirname(__file__), "data/v3description.xml")
        ) as file:
            mocked.get(
                LOCATION,
                body=file.read()
            ...
            mocked.get('http://mydevice:12345/4c494e4e-1234-ab12-abcd-01234567819f/Upnp/av.openhome.org-Volume-3/service.xml', body='')
